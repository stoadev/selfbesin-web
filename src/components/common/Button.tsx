type ButtonProps = {
  variant?: "primary" | "secondary" | "third" | "ghost" | "red";
  size?: "sm" | "md" | "lg";
  loading?: boolean;
  disabled?: boolean;
  onClick?: () => void;
...
const variantClasses = {
  ...
  red: "bg-white text-red-600 border border-red-600 hover:bg-red-100 dark:bg-gray-900 dark:text-red-600 dark:border-red-600 dark:hover:bg-red-900",
};
